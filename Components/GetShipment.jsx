          ...
          <div className="max-w-sm mx-auto py-3 space-y-3 text-center">
            ...
            <form onSubmit={(e) => e.preventDefault()}>
              ...
              <button
                ...
                className="block w-full mt-3 py-3 px-4 font-medium text-sm text-center text-white bg-[#2D3142] hover:bg-[#D89527] active:bg-[#2D3142] rounded-lg ring-offset-2 ring-[#D89527] focus:ring-2"
              >
                Get Details
              </button>
            </form>
            ...
            {singleShipmentData == undefined ? (
              ...
              <div className="text-left">
                ...
                <p>EC: {singleShipmentData.distance}</p>
